...
const copy = {
  sv: {
    ...
    shortNoticeEyebrow: "Meddelande",
    shortNoticeTitle: "Upplysning om kort varsel",
    shortNoticeMessage:
      "Den avsedda väderleveransen ligger nu så nära i tiden att tjänsten inte kan garantera leverans av ultraspecifikt eller ovanligt väder med så kort varsel. Om du ändå önskar fortsätta behöver detta meddelande först godtas.",
    shortNoticeAccept: "Meddelandet godtas",
    shortNoticeCancel: "Avbryt",
    databaseDisabled:
    ...
    bookingsLoadFailed: "Det gick inte att läsa bokningarna just nu.",
    ...
    pastDateUnavailable: "Du kan inte boka väder bakåt i tiden.",
    shortNoticeConfirmationRequired: "Bekräfta meddelandet om kort varsel innan bokningen slutförs.",
  ...
  en: {
    ...
    shortNoticeEyebrow: "Notice",
    shortNoticeTitle: "Short-Notice Advisory",
    shortNoticeMessage:
      "The intended weather delivery is now sufficiently close in time that the service cannot guarantee delivery of ultraspecific or unusual weather on such short notice. If you still wish to proceed, this notice must first be accepted.",
    shortNoticeAccept: "Accept notice",
    shortNoticeCancel: "Cancel",
    databaseDisabled:
    ...
    bookingsLoadFailed: "Could not load bookings right now.",
    ...
    pastDateUnavailable: "You cannot book weather in the past.",
    shortNoticeConfirmationRequired: "Accept the short-notice advisory before completing the booking.",
